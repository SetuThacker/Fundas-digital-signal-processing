...
#                script (type 'fir_interpolator.sh -help' for more information).
#
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.fir_interpolator -o fir_interpolator_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./fir_interpolator_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key fir_interpolator_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc fir_interpolator_simv.daidir vcs_lib c.obj)
