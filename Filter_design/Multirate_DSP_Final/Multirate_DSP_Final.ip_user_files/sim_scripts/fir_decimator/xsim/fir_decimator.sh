...
#
# Script generated by Vivado on Mon Jun 29 20:36:21 +0530 2026
# SW Build 3865809 on Sun May  7 15:05:29 MDT 2023
#
# Tool Version Limit: 2023.05 
#
# Filename     : fir_decimator.sh
...
#
# Usage        : fir_decimator.sh
#                fir_decimator.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                fir_decimator.sh [-reset_run]
#                fir_decimator.sh [-reset_log]
#                fir_decimator.sh [-help]
#
...
# script info
echo -e "fir_decimator.sh - Script generated by export_simulation (Vivado v2023.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./fir_decimator.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xbip_utils_v3_0_10 -L axi_utils_v2_0_6 -L fir_compiler_v7_2_19 -L xil_defaultlib -L secureip -L xpm --snapshot fir_decimator xil_defaultlib.fir_decimator -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim fir_decimator -key {Behavioral:sim_1:Functional:fir_decimator} -tclbatch cmd.tcl -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb fir_decimator.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./fir_decimator.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: fir_decimator.sh [-help]\n\
Usage: fir_decimator.sh [-step]\n\
Usage: fir_decimator.sh [-lib_map_path]\n\
Usage: fir_decimator.sh [-reset_run]\n\
Usage: fir_decimator.sh [-reset_log]\n\
Usage: fir_decimator.sh [-keep_index]\n\
Usage: fir_decimator.sh [-noclean_files]\n\n\
